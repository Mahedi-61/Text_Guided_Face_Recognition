...
text_folders = os.listdir("text")
img_folders = os.listdir("images")
...
for new_i, id in enumerate(img_folders[0:50]):
    iid_dir = os.path.join("images", id)
    tid_dir = os.path.join("text", id)
